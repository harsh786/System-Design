...
This directory is organized by interview problem category. Each design is still numbered so you can follow the original learning order, while the folder names make it easier to pick problems by domain and interview theme.

Use [HLD_INTERVIEW_TEMPLATE.md](HLD_INTERVIEW_TEMPLATE.md) as the repeatable answer framework before opening any problem-specific design.
