...
public class Problem09_GenerateParentheses {
    ...
    public static void main(String[] args) { System.out.println(new Problem09_GenerateParentheses().generateParenthesis(3)); }
}
