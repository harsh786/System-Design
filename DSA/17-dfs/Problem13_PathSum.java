 ...
 * Approach: DFS checking if leaf node sum equals target
 * Time: O(N), Space: O(H) height of tree
 * Production Analogy: Validating a transaction path meets a threshold in payment routing
 */
public class Problem13_PathSum {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(new Problem13_PathSum().hasPathSum(root, 22)); // true
    }
}
