...
// Rolling Hash for Near-Duplicate Documents
public class Problem28_RollingHashForNearDuplicateDocuments {
    ...
    public static void main(String[] args) {
        System.out.println("Rolling Hash for Near-Duplicate Documents");
