...
// Rolling Hash Collision Probability Analysis
public class Problem43_RollingHashCollisionProbabilityAnalysis {
    ...
    public static void main(String[] args) {
        System.out.println("Rolling Hash Collision Probability Analysis");
