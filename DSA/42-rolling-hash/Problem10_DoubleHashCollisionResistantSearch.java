...
// Double Hash Collision-Resistant Search
public class Problem10_DoubleHashCollisionResistantSearch {
    ...
    public static void main(String[] args) {
        System.out.println("Double Hash Collision-Resistant Search");
