...
public class Problem26_OfflineGreaterThanQueries {
    int[] bit;
    int n;

    Problem26_OfflineGreaterThanQueries(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem26_OfflineGreaterThanQueries ft = new Problem26_OfflineGreaterThanQueries(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("Offline Greater-Than Queries");
