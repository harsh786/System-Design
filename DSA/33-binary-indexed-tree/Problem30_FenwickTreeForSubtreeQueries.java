...
public class Problem30_FenwickTreeForSubtreeQueries {
    int[] bit;
    int n;

    Problem30_FenwickTreeForSubtreeQueries(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem30_FenwickTreeForSubtreeQueries ft = new Problem30_FenwickTreeForSubtreeQueries(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("Fenwick Tree for Subtree Queries");
