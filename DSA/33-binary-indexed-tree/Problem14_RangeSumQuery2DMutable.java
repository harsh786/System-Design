...
public class Problem14_RangeSumQuery2DMutable {
    int[] bit;
    int n;

    Problem14_RangeSumQuery2DMutable(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem14_RangeSumQuery2DMutable ft = new Problem14_RangeSumQuery2DMutable(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("Range Sum Query 2D Mutable");
