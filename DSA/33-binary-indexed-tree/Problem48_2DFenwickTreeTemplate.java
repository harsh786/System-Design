...
// 2D Fenwick Tree Template
public class Problem48_2DFenwickTreeTemplate {
    int[] bit;
    int n;

    Problem48_2DFenwickTreeTemplate(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem48_2DFenwickTreeTemplate ft = new Problem48_2DFenwickTreeTemplate(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("2D Fenwick Tree Template");
