...
// Fenwick Tree lower_bound
public class Problem24_FenwickTreeLowerBound {
    int[] bit;
    int n;

    Problem24_FenwickTreeLowerBound(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem24_FenwickTreeLowerBound ft = new Problem24_FenwickTreeLowerBound(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("Fenwick Tree lower_bound");
