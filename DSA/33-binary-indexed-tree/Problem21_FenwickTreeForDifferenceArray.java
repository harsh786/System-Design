...
public class Problem21_FenwickTreeForDifferenceArray {
    int[] bit;
    int n;

    Problem21_FenwickTreeForDifferenceArray(int n) { this.n = n; bit = new int[n + 1]; }
    ...
    public static void main(String[] args) {
        Problem21_FenwickTreeForDifferenceArray ft = new Problem21_FenwickTreeForDifferenceArray(10);
        ft.update(1, 5);
        ft.update(3, 7);
        ft.update(5, 3);
        System.out.println("Fenwick Tree for Difference Array");
